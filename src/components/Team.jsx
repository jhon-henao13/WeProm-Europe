...
// ─────────────────────────────────────────────────────────────
// Subcomponente: Anillos Animados Recalculados para viewBox 292
// ─────────────────────────────────────────────────────────────
function AnimatedRings({ active }) {
  useEffect(() => { injectEuropeStyles(); }, []);

  // Recálculo exacto para contenedor de 240x240 (Marco interno imagen = 212x212, margen = 14)
  const r = 112;
  const cx = 120;
  const cy = 120;
  ...
  return (
    <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 240 240" fill="none">
      ...
      {/* Círculo completo de enfoque interactivo */}
      {active && (
        <circle
...
// ─────────────────────────────────────────────────────────────
// Subcomponente: Tarjeta de Colaborador Redonda e Interactiva (292px)
// ─────────────────────────────────────────────────────────────
    ...
    >
      <div className="relative" style={{ width: 240, height: 240 }}>
        ...
        >
          ...
          {/* Texto superpuesto al activarse */}
          <div
...
// ─────────────────────────────────────────────────────────────
// Componente de Sección Principal
// ─────────────────────────────────────────────────────────────
export const Team = () => {
    ...
    <section className="w-full py-24 md:py-32 overflow-hidden bg-transparent border-b border-slate-100">
      <div className="max-w-7xl mx-auto px-6 md:px-16">
        ...
        <div className="relative mb-14">
          ...
          {/* Degradados laterales ópticos ajustados */}
