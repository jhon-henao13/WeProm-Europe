      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative z-10 border-t border-slate-100 pt-6 reveal">
          ...
          <p className="text-black font-montserrat text-base md:text-lg font-light leading-relaxed tracking-wide mb-14">
            <strong className="font-semibold text-slate-700">No operamos como una agencia.</strong> Somos un socio estratégico que integra investigación de mercados, estrategia y ejecución bajo nuestra propia metodología, con un equipo internacional que entiende los dos lados del Atlántico. Trabajamos en tres áreas que se refuerzan entre sí:
          </p>
